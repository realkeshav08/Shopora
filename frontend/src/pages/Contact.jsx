        ...
        <div className='flex flex-col justify-center items-start gap-8 md:w-1/2'>
          ...
          <div className='space-y-4 pt-4'>
            ...
            <button 
              ...
              className='bg-white border-2 border-primary text-primary px-10 py-4 rounded-2xl text-sm font-bold hover:bg-primary hover:text-white transition-all duration-500 shadow-sm active:scale-95'
            >
                EXPLORE JOBS
            </button>
          </div>
